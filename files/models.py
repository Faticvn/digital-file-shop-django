...
class DigitalFileQuerySet(models.QuerySet):
    def active(self):
        return self.filter(is_active=True)


class DigitalFileManager(models.Manager):
    def get_queryset(self):
        return DigitalFileQuerySet(self.model, using=self._db)
...
class ArticleDetail(models.Model):
    digital_file = models.OneToOneField(
        DigitalFile,
        on_delete=models.CASCADE,
